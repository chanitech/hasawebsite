    ...
    <div class="container">
        <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-6">
                <h4 class="fw-bold mb-3">MEMAFarms</h4>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                @if($contact)
                    <ul class="list-unstyled footer-contact">
                        ...
                        <li><i class="fas fa-envelope me-2"></i>{{ $contact->email ?? 'info@memafarms.com' }}</li>
                    </ul>
                @endif
            </div>
        </div>
        ...
        <div class="row align-items-center pb-3">
            <div class="col-md-6 text-center text-md-start small text-white-50">© {{ date('Y') }} MEMAFarms. All rights reserved.</div>

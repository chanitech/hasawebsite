...
{{-- STICKY TOP BAR --}}
<div class="bg-dark text-white py-1 d-none d-md-block sticky-top" style="z-index:1050;">
...
<section class="py-5">
    <div class="container">
        ...
        <div class="text-center mb-5 animate__animated animate__fadeInDown">
            ...
            <img src="{{ asset('assets/images/introduction/IntroductionOne/content-deco.png') }}" 
                 alt="decoration" class="mt-2">
        </div>
